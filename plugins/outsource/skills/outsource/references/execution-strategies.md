...
|---|---|---|
| Direct | Small, clear, low-risk work with an obvious check | Discovery or independent verification is material |
...
One agent may perform roles sequentially in Direct or capacity-limited work, but it must make a fresh verification pass from the contract rather than self-approve from memory.
