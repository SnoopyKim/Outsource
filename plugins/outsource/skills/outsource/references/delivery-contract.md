...
- Engagement mode: Direct | Scoped | Project
- Maker:
- Outsource host:
- Updated:
...
Direct work may keep the contract implicit, but Outsource should still declare the intended result and planned verification before making a risky or non-obvious change.
